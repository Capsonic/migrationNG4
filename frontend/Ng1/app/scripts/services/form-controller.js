...
/**
 * @ngdoc service
 * @name Ng1.baseControllers
 * @description
 * # baseControllers
 * Service in the Ng1.
 */
angular.module('Ng1').factory('formController', function($log, $routeParams, validatorService, appConfig, $timeout, $rootScope, $q, $activityIndicator) {
